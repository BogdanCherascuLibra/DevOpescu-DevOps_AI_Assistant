...
This module exposes endpoints for creating, listing, reading,
updating, and deleting user conversations.
"""
...
def list_conversations(
    ...
    """Return all conversations belonging to the selected user."""
    user_id = session_manager.get_or_create_user(
        username
    )
...
def get_conversation_history(
    ...
    """Return conversation metadata, messages, and usage statistics."""
    user_id = session_manager.get_or_create_user(
        username
    )
...
def send_message(
    ...
    """Send a user message to the assistant and store the response."""
    user_id = session_manager.get_or_create_user(
        username
    )
    ...
    # Rebuild the agent using the conversation history stored in SQLite.
    ...
    # Save the usage generated by the current request
    # and return the cumulative conversation totals.
...
def delete_conversation(
    ...
    """Delete a conversation belonging to the selected user."""
    user_id = session_manager.get_or_create_user(
        username
    )
