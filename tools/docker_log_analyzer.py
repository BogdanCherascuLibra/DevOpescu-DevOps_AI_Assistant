...
ERROR_PATTERNS = [
    {
        ...
        "pattern": r"(ModuleNotFoundError|ImportError|cannot find module|package .* not found)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(permission denied|operation not permitted|EACCES)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(address already in use|port .* already allocated|EADDRINUSE)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(connection refused|ECONNREFUSED|could not connect|connection timed out)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(temporary failure in name resolution|name or service not known|ENOTFOUND)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(no such file or directory|FileNotFoundError|ENOENT)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(environment variable .* not set|missing environment variable|KeyError:)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(out of memory|OOMKilled|cannot allocate memory|killed process)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(authentication failed|access denied|unauthorized|invalid credentials)",
        "probable_cause": (
    ...
    },
    {
        ...
        "pattern": r"(database .* unavailable|could not connect to database|database connection failed)",
        "probable_cause": (
...
def analyze_docker_logs(logs: str) -> dict[str, Any]:
    """Analyze user-provided Docker logs using known error patterns."""
    ...
    for error_pattern in ERROR_PATTERNS:
        ...
        if match:
            findings.append({
                ...
                "probable_cause": error_pattern["probable_cause"],
                "recommendation": error_pattern["recommendation"],
